...
@section('title', config('app.name'). ' | All Videos')
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="subheader py-2 py-lg-6 subheader-transparent" id="kt_subheader">
            <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                <!--begin::Page Title-->
                <h2 class="text-dark font-weight-bold my-1 mr-5">all videos</h2>
                <!--end::Page Title-->
                <!--begin::Breadcrumb-->
                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap py-5">
                        <div class="card-title">
                            <h3 class="card-label">all videos</h3>
                        </div>
                        <div class="card-toolbar">
                            <!--begin::Button-->
                            <a href="{{ route('dashboard.videos.create') }}"
                        ...
                        <table id="my_datatable" class="text-center">
                            ...
                            @foreach($videos as $index => $video)
                                <tr>
                                    ...
                                    <th>
                                        <a href="{{ route('dashboard.courses.show', $video->course_id) }}"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('dashboard.videos.destroy') }}" method="post" class="form_delete">
                        @csrf
                        @method('delete')
