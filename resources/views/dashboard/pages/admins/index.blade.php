...
@section('title', config('app.name') . ' | Admins')
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="subheader py-2 py-lg-6 subheader-transparent" id="kt_subheader">
            <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                <!--begin::Page Title-->
                <h2 class="text-dark font-weight-bold my-1 mr-5">all admins</h2>
                <!--end::Page Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    <li class="breadcrumb-item text-muted">all admins</li>
                </ul>
                <!--end::Breadcrumb-->
            </div>
        </div>
                        ...
                        <table id="my_datatable" class="text-center">
                            ...
                            @foreach($admins as $index => $admin)
                                <tr>
                                    ...
                                    <th>{{ $admin->name }}</th>
                                    <th>
                                        <img src="{{ $admin->image_path }}" width="100" alt="">
                                    </th>
                                    <th class="text-lowercase">{{ $admin->email }}</th>
                                    <th>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="modal-title" id="exampleModalLabel">delete admin</h2>
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('dashboard.admins.destroy') }}" method="post" class="form_delete">
                        @csrf
                        @method('delete')
