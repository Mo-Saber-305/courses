    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="subheader py-2 py-lg-6 subheader-transparent" id="kt_subheader">
            <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                <!--begin::Page Title-->
                <h2 class="text-dark font-weight-bold my-1 mr-5">all users</h2>
                <!--end::Page Title-->
                <!--begin::Breadcrumb-->
                        ...
                        <table id="my_datatable" class="text-center">
                            ...
                            @foreach($users as $index => $user)
                                <tr>
                                    ...
                                    <th>{{ $user->name }}</th>
                                    <th>
                                        <img src="{{ $user->image_path }}" width="100" alt="">
                                    </th>
                                    <th class="text-lowercase">{{ $user->email }}</th>
                                    <th>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('dashboard.users.destroy') }}" method="post" class="form_delete">
                        @csrf
                        @method('delete')
