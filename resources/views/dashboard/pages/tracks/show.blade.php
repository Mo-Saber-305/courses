...
@section('title', config('app.name') . ' | Track Show')
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="subheader py-2 py-lg-6 subheader-transparent" id="kt_subheader">
            <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                <!--begin::Page Title-->
                <h2 class="text-dark font-weight-bold my-1 mr-5">show track</h2>
                <!--end::Page Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item text-muted"> show track</li>
                </ul>
                <!--end::Breadcrumb-->
            </div>
        </div>
                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap py-5">
                        <div class="card-title">
                            <h3 class="card-label">Track name: <strong>{{ $track->name }}</strong></h3>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="card card-custom">
                            <div class="card-header flex-wrap py-5">
                                <div class="card-title">
                                    <h2 class="card-label">Course list</h2>
                                </div>

                                <a href="{{ route('dashboard.track.course.create', $track->id) }}"
                                ...
                                <table id="my_datatable" class="text-center">
                                    ...
                                    @foreach($track->courses as $index => $course)
                                        <tr>
                                            ...
                                            <th>( {{ $course->users->count() }} ) student</th>
                                            <th>
                                                <span
                                                    class="{{ $course->status == true ? 'text-danger' : 'text-success' }}">{{ $course->status == true ? 'paid' : 'free' }}</span>
                                            </th>
                                            <th>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('dashboard.track.course.destroy') }}" method="post" class="form_delete">
                        @csrf
                        @method('delete')
