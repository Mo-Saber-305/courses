...
@section('title', config('app.name') . ' | All Quizzes')
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="subheader py-2 py-lg-6 subheader-transparent" id="kt_subheader">
            <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                <!--begin::Page Title-->
                <h2 class="text-dark font-weight-bold my-1 mr-5">all quizzes</h2>
                <!--end::Page Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    <li class="breadcrumb-item text-muted">all quizzes</li>
                </ul>
                <!--end::Breadcrumb-->
            </div>
        </div>
                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap py-5">
                        <div class="card-title">
                            <h3 class="card-label">all quizzes</h3>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <table id="my_datatable" class="text-center">
                            ...
                            <tr>
                                ...
                                <th><strong>no. questions</strong></th>
                            ...
                            @foreach($quizzes as $index => $quiz)
                                <tr>
                                    <th>{{ $index + 1 }}</th>
                                    <th>{{ Str::limit($quiz->name, 40) }}</th>
                                    <th> {{ $quiz->questions_count }} </th>
                                    <th>
                                        <a href="{{ route('dashboard.courses.show', $quiz->course_id) }}"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="modal-title" id="exampleModalLabel">delete quiz</h2>
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('dashboard.quizzes.destroy') }}" method="post" class="form_delete">
                        @csrf
                        @method('delete')
