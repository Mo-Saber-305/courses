...
<head>
    ...
    <link href="{{ asset('dashboard/css/pages/login/classic/login-3.css') }}" rel="stylesheet" type="text/css"/>
...
<div class="d-flex flex-column flex-root">
    ...
    <div class="login login-3 login-signin-on d-flex flex-row-fluid" id="kt_login">
        <div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid"
             style="background-image: url({{ asset('dashboard/media/bg/bg-1.jpg') }});">
            <div class="login-form text-center text-white p-7 position-relative overflow-hidden">
                <!--begin::Login Header-->
                <div class="d-flex flex-center mb-15">
                    <a href="{{ url('/') }}">
                        <img src="{{ asset('dashboard/media/logos/logo-letter-9.png') }}" class="max-h-100px" alt=""/>
                    </a>
                </div>
                @yield('content')
            </div>
...
<script src="{{ asset('dashboard/js/pages/custom/login/login-general.js') }}"></script>
<!--end::Page Scripts-->
</body>
<!--end::Body-->
</html>
